            ...
            <div className="flex-1 pt-2 md:pt-8 text-center md:text-left space-y-4">
                ...
                <div className="flex w-full max-w-xl flex-row items-center justify-center md:justify-start gap-2 sm:gap-4 py-2">
                    <button
                        onClick={onWatch}
                        disabled={isLoading}
                        className="h-12 min-w-0 flex-1 justify-center px-3 sm:px-8 bg-yorumi-accent hover:bg-yorumi-accent/90 text-white text-base sm:text-lg font-bold rounded-full transition-transform active:scale-95 flex items-center gap-2 sm:gap-3 shadow-lg shadow-yorumi-accent/20 whitespace-nowrap"
                    >
                    ...
                    <div className="relative min-w-0 flex-1">
                        <button
                            ...
                            disabled={isLoading}
                            className={`h-12 w-full min-w-0 px-3 sm:px-8 text-base sm:text-lg font-bold rounded-full transition-all border flex items-center justify-center gap-2 whitespace-nowrap ${inList
